...
describe("[PATCH] /users/:user_id/admin", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(index_1.app).patch("/users/".concat(user.id, "/admin"))];
                case 1:
                    response = _a.sent();
                    expect(response.body).toMatchObject({
                        name: user.name,
    ...
    it("should not be able to turn a non existing user as admin", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.app)
                        .patch("/users/".concat((0, uuid_1.v4)(), "/admin"))
                        .expect(404)];
                case 1:
                    response = _a.sent();
                    expect(response.body.error).toBeTruthy();
...
describe("[GET] /users/:user_id", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(index_1.app).get("/users/".concat(user.id))];
                case 1:
                    response = _a.sent();
    ...
    it("should not be able to show profile of a non existing user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.app).get("/users/".concat((0, uuid_1.v4)())).expect(404)];
                case 1:
                    response = _a.sent();
                    expect(response.body.error).toBeTruthy();
                    return [2 /*return*/];
